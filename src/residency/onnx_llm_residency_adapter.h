...
struct OnnxLlmResidencyReport {
  ...
  std::size_t session_run_count = 0;
  std::size_t bound_cpu_input_count = 0;
  std::size_t bound_cuda_input_count = 0;
  std::size_t bound_cpu_output_count = 0;
  std::size_t bound_cuda_output_count = 0;
  std::size_t explicit_host_to_device_copies = 0;
  ...
  std::string kv_input_bound_device;
  std::string logits_output_bound_device;
  std::string present_output_bound_device;
